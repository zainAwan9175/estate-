...
function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await axios.get(`https://estate-api-orcin.vercel.app/listining/search?offer=true&limit=4`);
      ...
      try {
        const response = await axios.get(`https://estate-api-orcin.vercel.app/listining/search?type=sale&limit=4`);
      ...
      try {
        const response = await axios.get(`https://estate-api-orcin.vercel.app/listining/search?type=rent&limit=4`);
