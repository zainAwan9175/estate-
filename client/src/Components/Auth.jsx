...
function Auth() {
    ...
    async function handleGoogleSubmission() {
        try {
            ...
            axios.post("https://estate-liard.vercel.app/auth/google", { name: result.user.displayName, email: result.user.email, photo: result.user.photoURL }, { withCredentials: true })
                .then((res) => {
