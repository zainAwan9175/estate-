  ...
  return (
    <div className="relative">
      <div className="flex justify-center items-center gap-2">
        {/* Share button */}
        <div
          className="fixed top-24 md:right-10 right-5 text-white text-[20px] md:text-[30px] z-30 bg-blue-700 cursor-pointer hover:bg-blue-900 rounded-full duration-500"
          onClick={() => {
        ...
        <div
          className={`fixed top-44 z-30 right-10 bg-white text-blue-700 p-2 rounded-2xl text-[16px] ${copied === false && "hidden"}`}
        >
          Link copied!
        </div>
              ...
              <div className="flex gap-5 flex-col">
                ...
                <div className="gap-4 flex flex-col">
                  ...
                  <div className="flex justify-center md:pr-64 flex-col items-center">
                    ...
                    {/* Show "Contact Landlord" button only if user is logged in */}
                    {currentuser && listing.userref !== currentuser._id && !textareacondition && (
                      <button
                        onClick={() => {
                          setTextareacondition(!textareacondition);
                        }}
